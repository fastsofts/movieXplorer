...
export const metadata: Metadata = {
  title: 'Home | MovieXplorer',
  description: 'Welcome to MovieXplorer - Discover amazing movies, actors, and directors',
};

export default function HomePage() {
  return (
    <div className="h-full overflow-y-auto bg-gradient-to-br from-gray-900 to-gray-800 text-white scrollable-content">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
          <Link 
            href="/movies" 
            className="bg-gray-800 hover:bg-gray-700 rounded-lg p-8 transition transform hover:scale-105"
          >
